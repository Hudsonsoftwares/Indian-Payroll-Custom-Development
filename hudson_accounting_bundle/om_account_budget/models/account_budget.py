...
class CrossoveredBudgetLines(models.Model):
    ...
    budget_id = fields.Many2one('crossovered.budget', related='crossovered_budget_id', string='Budget')
    ...
    theoretical_amount = fields.Monetary(
        related='theoritical_amount', string='Theoretical Amount (Alias)')
    ...
    def _compute_practical_amount(self):
        for line in self:
            ...
            if line.analytic_account_id.id:
                ...
                result = analytic_line_obj._read_group(domain, [], ['amount:sum'])
                ...
                result = aml_obj._read_group(domain, [], ['credit:sum', 'debit:sum'])
                if result and result[0]:
                    credit = result[0][0] or 0.0
                    debit = result[0][1] or 0.0
