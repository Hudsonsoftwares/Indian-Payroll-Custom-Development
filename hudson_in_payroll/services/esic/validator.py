...
class ESICValidator(BaseStatutoryService):
    ...
    def is_esic_eligible(self, payslip, gross_wage=None):
        ...
        if not period_service.is_covered_for_contribution_period(employee, eval_date=eval_date, current_wage=gross_wage):
            return False
